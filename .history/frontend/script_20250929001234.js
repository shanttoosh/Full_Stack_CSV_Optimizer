...
async function processDynamicStepByStep(file) {
    ...
    try {
        ...
        // Stop timers and update with real timing from the actual timers
        ...
        // Use the actual timer values (which are truly dynamic based on processing time)
        totalProcessingTime += realBackendTime;
        
        console.log(`✅ Real backend processing completed in ${realBackendTime.toFixed(2)}s`);
        console.log(`📊 Dynamic timers - Storing: ${storingTime}s, Retrieval: ${retrievalTime}s`);
