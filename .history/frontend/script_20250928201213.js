...
function showRealDownloadButtons(downloadLinks) {
    ...
    if (!downloadSection) {
        ...
        downloadSection.innerHTML = `
            ...
            <div id="download-buttons" class="form-group" style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center; width: 100%; box-sizing: border-box; overflow: hidden;"></div>
        `;
